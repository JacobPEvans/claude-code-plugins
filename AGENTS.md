...
| **git-workflows** | Command/Skill | `/rebase-pr`, `/sync-main`, `/refresh-repo`, `/wrap-up`, `/troubleshoot-rebase`, `/troubleshoot-precommit`, `/troubleshoot-worktree`, `/gh-cli-patterns` | Git sync, refresh, and PR merge workflows |
| **github-workflows** | Command/Skill | `/ship`, `/finalize-pr`, `/squash-merge-pr`, `/resolve-pr-threads`, `/shape-issues`, `/trigger-ai-reviews`, `/gh-cli-patterns` | GitHub PR/issue management workflows |
